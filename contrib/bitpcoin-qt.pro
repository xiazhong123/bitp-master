...
RESOURCES += src/qt/bitpcoin.qrc src/qt/bitpcoin_locale.qrc

TRANSLATIONS += src/qt/locale/bitpcoin_bg.ts \
                src/qt/locale/bitpcoin_de.ts \
                src/qt/locale/bitpcoin_en.ts \
                src/qt/locale/bitpcoin_es.ts \
                src/qt/locale/bitpcoin_fi.ts \
                src/qt/locale/bitpcoin_fr.ts \
                src/qt/locale/bitpcoin_it.ts \
                src/qt/locale/bitpcoin_ja.ts \
                src/qt/locale/bitpcoin_pl.ts \
                src/qt/locale/bitpcoin_pt.ts \
                src/qt/locale/bitpcoin_ru.ts \
                src/qt/locale/bitpcoin_sk.ts \
                src/qt/locale/bitpcoin_sv.ts \
                src/qt/locale/bitpcoin_vi.ts \
                src/qt/locale/bitpcoin_zh_CN.ts \
                src/qt/locale/bitpcoin_zh_TW.ts
