...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* bitp features */
        {"bitp", "masternode", &masternode, true, true, false},
        {"bitp", "listmasternodes", &listmasternodes, true, true, false},
        {"bitp", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitp", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitp", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitp", "masternodedebug", &masternodedebug, true, true, false},
        {"bitp", "startmasternode", &startmasternode, true, true, false},
        {"bitp", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitp", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitp", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitp", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitp", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitp", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitp", "mnsync", &mnsync, true, true, false},
        {"bitp", "spork", &spork, true, true, false},
        {"bitp", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitp", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
        ...
        {"wallet", "getaddressbitpyaccount", &getaddressbitpyaccount, true, false, true},
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitpcoind, or the -server option to bitpcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"bitp Alert\" admin@foo.com\n"),
...
{
    return "> bitpcoin-cli " + methodname + " " + args + "\n";
}
