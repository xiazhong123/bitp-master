...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BITP Core TX utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitpcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitpcoin transaction") + "\n" +
                               "  bitpcoin-tx [options] -create [commands]   " + _("Create hex-encoded bitpcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitpcoin transaction
