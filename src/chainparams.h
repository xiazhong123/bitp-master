 ...
 * bitpcoin system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& bitpcoinDevKey() const { return vbitpcoinDevKey; }
    // const std::vector<unsigned char>& bitpcoinFundKey() const { return vbitpcoinFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vbitpcoinDevKey;
    // std::vector<unsigned char> vbitpcoinFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
