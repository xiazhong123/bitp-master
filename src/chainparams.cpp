...
public:
    CMainParams()
    {
        ...
        //vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("seed1.cashollar.com", "seed21.cashollar.com"));
        vSeeds.push_back(CDNSSeedData("seed2.cashollar.com", "seed22.cashollar.com"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 25); // C
        ...
        strDevFeeAddress = "BRpECPiEX4iNxbe199GrX3VPGxxzd69tH4";
        ...
        strObfuscationPoolDummyAddress = "BRpECPiEX4iNxbe199GrX3VPGxxzd69tH4";
