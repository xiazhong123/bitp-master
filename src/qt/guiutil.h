...
/** Utility functions used by the bitpcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render bitpcoin addresses in monospace font
...
// Parse "bitpcoin:" URI into recipient object, return true on successful parsing
