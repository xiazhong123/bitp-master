...
QFontDatabase::addApplicationFont(":/fonts/bitpcoin_font");

QString windowTitle = tr("BITP") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BITP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BITP: URIs)"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BITP wallet"), this);
    aboutAction->setStatusTip(tr("Show information about BITP wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BITP wallet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BITP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/transaction_0")), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BITP addresses"));
    ...
    openAction->setStatusTip(tr("Open a BITP: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BITP help message to get a list with possible BITP command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BITP client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BITP network", "", count));
}
...
{
    QString strTitle = tr("BITP"); // default title
