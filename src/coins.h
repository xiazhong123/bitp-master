...
/**
    ...
    ****Note - for bitpcoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /**
     * Amount of bitpcoin coming in to a transaction
