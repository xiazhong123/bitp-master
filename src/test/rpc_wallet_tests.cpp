...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    /*********************************
     * 		getaddressbitpyaccount
     *********************************/
    BOOST_CHECK_THROW(CallRPC("getaddressbitpyaccount"), runtime_error);
    BOOST_CHECK_NO_THROW(retValue = CallRPC("getaddressbitpyaccount " + strAccount));
