...
#if defined(NDEBUG)
#error "bitpcoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ubitpcoin) are considered zero fee (for relaying and mining)
...
CAmount GetBlockValue(int nHeight)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::TESTNET){
        ...
        } else if (nHeight >= 301 && nHeight < 518400) {
            nSubsidy = 46.527 * COIN;
        } else if (nHeight >= 518400 && nHeight < 1036800) {
            nSubsidy = 46.527 * COIN;
        } else if (nHeight >= 1036800 && nHeight < 1555200) {
            nSubsidy = 23.26 * COIN;
        } else if (nHeight >= 1555200 && nHeight < 2073600) {
            nSubsidy = 23.26 * COIN;
        } else if (nHeight >= 2073600 && nHeight < 2592000) {
            nSubsidy = 11.63 * COIN;
        } else if (nHeight >= 2592000 && nHeight < 3110400) {
            nSubsidy = 11.63 * COIN;
		} else if (nHeight >= 3110400 && nHeight < 3628800) {
            nSubsidy = 5.815 * COIN;
        } else if (nHeight >= 3628800 && nHeight < 4147200) {
            nSubsidy = 5.815 * COIN;
        } else if (nHeight >= 4147200 && nHeight < 4665600) {
            nSubsidy = 2 * COIN;
...
//        return 0;
    ...
    if (nProtocol >= CONSENSUS_FORK_PROTO) {
        switch(mnlevel) {
            case 1: return blockValue * 0.046;
            case 2: return blockValue * 0.082;
            case 3: return blockValue * 0.246;
            case 4: return blockValue * 0.626;
        }
    } else {
        switch(mnlevel) {
            case 1: return blockValue * 0.046;
...
{
    RenameThread("bitpcoin-scriptch");
