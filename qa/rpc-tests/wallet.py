...
#   c) node1 mines 32 blocks, so now node 0 has 60001 bitpcoin, node 1 has 4250 bitpcoin, node2 has none.
#   d) node0 sends 601 bitpcoin to node2, in two transactions (301 bitpcoin, then 300 bitpcoin).
