...
In order to support loading of multiple wallets in bitpcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitpcoin.cpp.
...
Changes to bitpcoin.cpp
----------------------
bitpcoin.cpp is the entry point into bitpcoin-qt, and as such, will require some minor modifications to provide hooks for
